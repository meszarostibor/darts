...
export const DartsMod = () => {
    ...
    const handleSubmit = (event) => {
        ...
        .then( response =>{
            if(!response.ok){
                throw new Error('Hiba a módosításban!')
            }
    ...
    return (
        <div className="p-5 m-auto text-center content bg-lavender">
            <div>
                <h2>Egy darts játékos módosítása</h2>
                <div className='card col-sm3 m-1 p-2' >
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='form-group  row pb-3'>
                            ...
                            <div  className='col-sm-9'>
                               {/* <input type="number" name='world_ch_won' className='form-control' defaultValue={darts.world_ch_won.toString()} onChange={handleInputChange} />*/}
                        ...
                        <div className='form-group  row pb-3'>
                            ...
                            <div  className='col-sm-9'>
                                ...
                                <img src={darts.image_url} style={{height:"200px"}} alt="" />
                            </div>
                        </div>
                        <Link to="/" className="bi bi-backspace-fill fs-5 btn btn-warning">Vissza</Link>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <button type="submit" className='bi bi-send btn btn-success fs-5'></button>
                    </form>
                </div>
            </div>
        </div>
